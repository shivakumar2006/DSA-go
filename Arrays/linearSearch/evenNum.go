...
func main() {
	...
	res := evenNum(arr)
	fmt.Printf("total even numbers of digits in the array : %d\n", res)
}
...
// 	arr := []int{10, 124, 9, 1764, 98, 1, 69}
// 	res := evenNum(arr)
// 	fmt.Printf("Total number os digits in the array : %d\n", res)
// }
...
// 	arr := []int{18, 124, 9, 1764, 98, 1, 69}
// 	res := evenNumbers(arr)
// 	fmt.Printf("Count of the numbers with even numbers of digits : %d\n", res)
// }
